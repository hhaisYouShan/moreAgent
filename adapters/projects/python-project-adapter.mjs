...
export function inspectPythonProject({
  ...
  return Object.freeze({
    ...
    dependencyGroups: Object.freeze(Object.keys(manifest['dependency-groups'] || {}).sort()),
    ...
    pyprojectPath,
    pyprojectHash: hashFile(manifestPath),
...
function hashFile(filePath) {
  const code = [
    ...
    `const value = fs.readFileSync(${JSON.stringify(filePath)})`,
    'process.stdout.write("sha256:" + crypto.createHash("sha256").update(value).digest("hex"))',
  ].join(';');
